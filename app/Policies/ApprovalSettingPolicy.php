...
class ApprovalSettingPolicy
{
     ...
     *
     * @param  \App\Models\User  $user
     * @param  \App\Models\ApprovalSetting  $approvalSetting
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, ApprovalSetting $approvalSetting)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, ApprovalSetting $approvalSetting)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, ApprovalSetting $approvalSetting)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, ApprovalSetting $approvalSetting)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, ApprovalSetting $approvalSetting)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, ApprovalSetting $approvalSetting)
    {
