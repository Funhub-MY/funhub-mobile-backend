...
use App\Filament\Resources\Merchants\RelationManagers\StoresRelationManager;
                        ...
                        Section::make('Basic Information')
                            ...
                            ->schema([
                                ...
                                Placeholder::make('business_phone_no')
                                    ...
                                    ->visible(fn (Get $get) => $get('has_auto_linked_user') === true),
