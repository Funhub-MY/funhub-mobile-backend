...
namespace App\Filament\Resources\RatingCategories;

use Filament\Schemas\Schema;
use Filament\Schemas\Components\Section;
use Filament\Actions\EditAction;
use Filament\Actions\DeleteBulkAction;
use App\Filament\Resources\RatingCategories\Pages\ListRatingCategories;
use App\Filament\Resources\RatingCategories\Pages\CreateRatingCategory;
use App\Filament\Resources\RatingCategories\Pages\EditRatingCategory;
...
class RatingCategoryResource extends Resource
{
    ...
    {
        return [
            'index' => ListRatingCategories::route('/'),
            'create' => CreateRatingCategory::route('/create'),
            'edit' => EditRatingCategory::route('/{record}/edit'),
        ];
    }
}
