...
use App\Jobs\ProcessMerchantOfferCampaignAfterSave;
...
//                $this->handleRecordUpdate($this->record, $data);
	...
	{
		// Dispatch job to handle the processing due to long process will cause timeout error
		ProcessMerchantOfferCampaignAfterSave::dispatch($this->record);
	}
