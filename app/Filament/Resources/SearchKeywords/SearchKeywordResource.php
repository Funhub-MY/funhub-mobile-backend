...
namespace App\Filament\Resources\SearchKeywords;

use Filament\Schemas\Schema;
use Filament\Schemas\Components\Section;
use Filament\Actions\EditAction;
use Filament\Actions\DeleteBulkAction;
use App\Filament\Resources\SearchKeywords\Pages\ListSearchKeywords;
use App\Filament\Resources\SearchKeywords\Pages\CreateSearchKeyword;
use App\Filament\Resources\SearchKeywords\Pages\EditSearchKeyword;
use App\Filament\Resources\SearchKeywordResource\Pages;
use App\Filament\Resources\SearchKeywordResource\RelationManagers;
use App\Filament\Resources\SearchKeywords\RelationManagers\ArticlesRelationManager;
...
class SearchKeywordResource extends Resource
{
    ...
    {
        return [
            'index' => ListSearchKeywords::route('/'),
            'create' => CreateSearchKeyword::route('/create'),
            'edit' => EditSearchKeyword::route('/{record}/edit'),
        ];
    }
}
