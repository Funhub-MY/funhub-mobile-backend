...
use App\Filament\Resources\Stores\RelationManagers\MerchantOffersRelationManager;
...
use App\Filament\Resources\Stores\RelationManagers\LocationRelationManager;
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('status')
                    ->badge()
                    ->formatStateUsing(fn ($state) => Store::STATUS[$state] ?? $state)
                ...
                TextColumn::make('business_phone_no')
				...
				ToggleColumn::make('is_appointment_only')
					->label('Appointment Only'),
