...
namespace App\Filament\Resources\MerchantOffers;
...
use Exception;
use App\Filament\Resources\MerchantOffers\RelationManagers\VouchersRelationManager;
use App\Filament\Resources\MerchantOffers\RelationManagers\LocationRelationManager;
use App\Filament\Resources\MerchantOffers\Pages\ListMerchantOffers;
use App\Filament\Resources\MerchantOffers\Pages\CreateMerchantOffer;
use App\Filament\Resources\MerchantOffers\Pages\EditMerchantOffer;
use Closure;
use Filament\Forms;
use App\Models\User;
...
class MerchantOfferResource extends Resource
{
                        ...
                        Section::make('Other')
                            ->schema([
                                ...
                                DatePicker::make('publish_at')
                                    ->label('Publish Date')
                                    ->visible(fn(Get $get) => $get('status') == MerchantOffer::STATUS_DRAFT)
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('campaign.name')
                    ->url(fn ($record) => (isset($record->campaign)) ? route('filament.admin.resources.merchant-offer-campaigns.edit', $record->campaign) : null)
                    ->searchable()
                    ->sortable(),
            ...
            ->recordActions([
                ...
                ReplicateAction::make('duplicate')
                    ...
                    ->mountUsing(fn (Schema $schema, MerchantOffer $record) => $schema->fill([
                    'sku' => $record->sku,
                    ...
                    ->afterReplicaSaved(function (MerchantOffer $replica, array $data): void {
                        ...
                        redirect()->route('filament.admin.resources.merchant-offers.edit', $replica);
            ...
            ->toolbarActions([
                ...
                BulkAction::make('force_sync_algolia')
    ...
    {
        return [
            'index' => ListMerchantOffers::route('/'),
            'create' => CreateMerchantOffer::route('/create'),
            'edit' => EditMerchantOffer::route('/{record}/edit'),
        ];
    }
}
