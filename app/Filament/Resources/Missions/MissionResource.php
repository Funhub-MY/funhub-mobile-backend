...
use App\Filament\Resources\Missions\RelationManagers\ParticipantsRelationManager;
                        ...
                        ->schema([
                          ...
                          // media gallery
                            SpatieMediaLibraryFileUpload::make('gallery')
                               ...
                               ->maxFiles(20)
                               ->rules('image'),
                            SpatieMediaLibraryFileUpload::make('mission_completed_image_en')
                               ...
                               ->maxFiles(20)
                               ->rules('image'),
                            SpatieMediaLibraryFileUpload::make('mission_completed_image_zh')
                ...
                ->schema([
                    ...
                    Section::make('Reward Details')
                        ->schema([
                            ...
                            Toggle::make('auto_disburse_rewards')
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                ...
                TextColumn::make('missionable.name')
                    ->label('Rewards')
                    ->sortable(),

                TextColumn::make('reward_quantity'),

                TextColumn::make('reward_limit'),

                TextColumn::make('auto_disburse_rewards')
                    ->label('Auto Disburse Rewards')
                    ->badge()
