    ...
    protected function getUserPurchasedBeforeFromMerchantIds($user)
    {
        ...
        if ($user && config('app.same_merchant_spend_limit')) {
            ...
            if (!$isWhitelisted) {
                ...
                $merchantUserWhitelist = [28825,93716,94359,94361,94377,94515,94516,94519,94520,94521,94522,94552,94557,94561,94588,94589,94590,94591,94592]; //Merchant Whitelist, user can view merchant offer after purchase
