...
class MerchantOfferClaimResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'redeem' => $this->redeem ? [
                'id' => $this->redeem->id,
                'claim_id' => $this->redeem->claim_id,
                'merchant_offer_id' => $this->redeem->merchant_offer_id,
                'user_id' => $this->redeem->user_id,
                'transaction_id' => $this->redeem->transaction_id,
                'quantity' => $this->redeem->quantity,
                'created_at' => Carbon::parse($this->redeem->created_at)->format('d/m/Y h:iA'),
                'updated_at' => Carbon::parse($this->redeem->updated_at)->format('d/m/Y h:iA'),
                'created_at_diff' => $this->redeem->created_at->diffForHumans(),
                'updated_at_diff' => $this->redeem->updated_at->diffForHumans(),
            ] : null,
