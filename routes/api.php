...
Route::group(['prefix' => 'v1', 'middleware' => 'setLocale'], function () {
    ...
    Route::middleware(['application.token'])->group(function() {
        Route::group(['prefix' => 'external'], function () {
            ...
            Route::get('store/{store_id}', [\App\Http\Controllers\Api\SyncMerchantPortalController::class, 'store']);
        });
    });
    ...
    Route::group(['middleware' => ['auth:sanctum', 'checkStatus']],  function() {
        ...
        Route::prefix('/kdcc')->group(function () {
            ...
            Route::get('/my_votes', [\App\Http\Controllers\Api\KdccController::class, 'getUserVotes']);
