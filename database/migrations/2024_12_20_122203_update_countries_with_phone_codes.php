...
return new class extends Migration
{
    ...
    public function up()
    {
        $countries = [
            ...
            ["country" => "Antigua and/or Barbuda", "code" => "1268"],
            ...
            ["country" => "Republic of South Sudan", "code" => "211"],
            ...
            ["country" => "Vatican City State", "code" => "379"],
        ...
        foreach ($countries as $countryData) {
            DB::table('countries')
                ...
                ->update(['phone_code' => $countryData['code']]);
        }
    }
    ...
    {
        DB::table('countries')->update(['phone_code' => null]);
    }
};
